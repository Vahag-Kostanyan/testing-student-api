...
function getSubPermissions(): array
{
    ...
    $student_role_update = Permission::where('page', '/manager/students')->where('method', 'update')->first();
    ...
    return [
        ...
        [
            "permission_id" => $student_role_update->id,
            "page" => '/manager/students/changePassword',
            "method" => "update"
        ],
        [
